...
const Experience = () => {
  ...
  return (
    <div className='grid -mt-20 gap-16 relative'>
      <motion.div
        className='absolute top-full shadow-[0px_0px_300px_50px_#0ea5e9]'
        animate={{
          x: [30, -20, 20, -30],
          y: [30, -20, 20, -30],
          rotate: [0, 90],
      ...
      <ol className='border-l border-zinc-400 lg:grid grid-flow-col auto-cols-fr lg:justify-center lg:gap-16 lg:border-l-0 lg:border-t'>
        {/* Experience 1 */}
        <li>
          ...
          <div className='mt-2 ml-4 pb-5 lg:ml-0'>
            ...
            <p className='mb-3 text-white'>
              <span className='text-sky-500'>{t('experience.tech')}:</span>{' '}
              React, Python, Django, MongoDB
            </p>
