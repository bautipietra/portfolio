      ...
      <ol
        ...
        <li>
          ...
          <div className="mt-2 ml-4 pb-5 lg:ml-0">
            <h4 className="mb-1.5 text-xl font-semibold">Next Step <span className='text-sky-400'>, Full Stack Developer</span></h4>
        ...
        <li>
          ...
          <div className="mt-2 ml-4 pb-5 lg:ml-0">
            <h4 className="mb-1.5 text-xl font-semibold">Coderhouse <span className='text-sky-400'>, {t('experience.coderhouse')}</span></h4>
            <p className="mb-3 text-white"><span className='text-sky-500'>{t('experience.tech')}:</span> React, Redux, Python, Django, MongoDB</p>
            <p className="mb-3 text-zinc-400 grid gap-2">
        ...
        <li>
          ...
          <div className="mt-2 ml-4 pb-5 lg:ml-0">
            <h4 className="mb-1.5 text-xl font-semibold">Soy Henry <span className='text-sky-400'>, {t('experience.soyhenry')}</span></h4>
            <p className="mb-3 text-white"><span className='text-sky-500'>{t('experience.tech')}:</span> React, Redux, Python, Django, MongoDB</p>
            <p className="mb-3 text-zinc-400 grid gap-2">
