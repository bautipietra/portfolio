        ...
        <div className='w-full'>
          ...
          <pre className='text-zinc-400 text-sm py-2 w-full relative'>
            ...
            <code id='code'>
              ...
              {'  '}{'  '}<span className="text-blue-400">const</span> {t('code.image')} <span className="text-blue-400">=</span> <span className="text-yellow-100 underline cursor-pointer cursorClick" onClick={() => setshowImage(true)} >bautista.jpg</span><br></br>
