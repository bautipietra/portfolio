        ...
        <AnimatePresence>
          {showImage && (
            <motion.div
              ...
              className='fixed h-full w-full z-10 grid place-content-center top-0 left-0  bg-black bg-opacity-50 backdrop-blur-sm cursorClick'
      ...
      <div className='bg-slate-900 bg-opacity-50 backdrop-blur-lg grid p-2 rounded-xl w-full divide-y-[1px] divide-zinc-600 gap-2'>
        <div className='flex justify-between items-center'>
          ...
          <MdFileCopy
            ...
            onClick={copyHandler}></MdFileCopy>
        </div>
        <div className='w-full'>
          ...
          <pre className='text-zinc-400 text-sm py-2 w-full relative'>
            ...
            <code id='code'>
              ...
              {t('code.welcome')} <span className='text-blue-400'>=</span>{' '}
